define(function(require) {
    ...
    RelatedDataComponent = BaseComponent.extend({
         ...
         */
        options: {
            relatedDataRoute: 'aakron_quote_related_data',
            formName: ''
        },
        ...
        loadRelatedData: function(customerUser) {
            ...
            mediator.trigger('quote:load:aakron-related-data');
            ...
            $.ajax({
                ...
                success: function(response) {
                    mediator.trigger('quote:loaded:aakron-related-data', response);
                },
                error: function() {
                    mediator.trigger('quote:loaded:aakron-related-data', {});
                }
            });
        },
