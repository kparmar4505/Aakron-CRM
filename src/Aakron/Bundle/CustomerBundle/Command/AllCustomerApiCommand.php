...
//         } else {
        ...
        //    print_r($customerArrayTmp);
            ...
            if(isset($responseData['data']))
            {
                ...
                {
                  //  $addressId = $this->addCustomerAddress($customer,$responseData["data"]["id"]);
                ...
                //    var_dump($responseData);exit;
                    $this->addCustomerAddress($customer,$responseData['data']['id']);
                }
            }    
...
//         }
    ...
    public function addCustomerAddress($customerData,$customerId)
    {
     //   var_dump($customerData);exit;
        ...
        $customerAddressArray['data']['relationships']['region']['data']=array('type' => 'regions','id' => 'US-'.$customerData['statecode']??"");
